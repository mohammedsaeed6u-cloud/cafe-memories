...
export const SAAS_PLANS: SubscriptionPlan[] = [
  ...
  },
  {
    ...
    currency: 'SAR',
    description: 'الخيار الأكثر شعبية للمقاهي ومحامص القهوة المختصة لربط الذكريات الرقمية بطباعة فورية فاخرة.',
    popular: true,
    badge: 'الأكثر طلباً للمقاهي المختصة',
    limits: {
    ...
    features: [
      ...
      'اعتماد فوري للذكريات عبر كود الباريستا السريع',
  ...
  },
  {
    ...
    nameEn: 'Multi-Location Roastery',
    monthlyPrice: 1190,
