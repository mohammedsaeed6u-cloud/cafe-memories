...
export const DEFAULT_BUSINESS_CONFIG: BusinessConfig = {
  ...
  freeGift: {
    enabled: true,
    title: 'هدية أو مكافأة خاصة مع شريط صورك',
    description: 'استلم هديتك أو خصمك الفوري من فريق الخدمة أو الكاشير عند إبراز كود الهدية!',
    terms: 'صالحة للاستلام الفوري مع توثيق شريط الذكريات',
  },
};
