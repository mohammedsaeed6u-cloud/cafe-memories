...
const FAQ_DATA: FaqItem[] = [
  ...
  {
    question: 'كيف تتم حماية الكافيه من التلاعب أو صرف الهدايا والأختام الوهمية؟',
    answer: 'التحقق من صحة الزيارات واستحقاق المكافآت يتم برمجياً على الخادم (Server-Side Verification) مع نظام منع التكرار خلال 24 ساعة (Cooldown Engine)، ولا يتم صرف الهدية للعميل إلا بإدخال رمز الـ Barista PIN السري المعتمد لطاقم المكان.',
  },
  {
  ...
  {
    question: 'هل يمكن تخصيص ألوان وشعار الكافيه بالكامل على الكروت وشاشات الصالة؟',
    answer: 'نعم بكل تأكيد، من خلال لوحة التاجر يمكنك رفع شعار علامتك التجارية، وتحديد اسم الفرع، واختيار ألوان كارت البولارويد وقواعد مكافآت الولاء المناسبة لنمط مقهاك المختص.',
  },
];
