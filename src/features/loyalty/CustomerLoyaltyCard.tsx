...
import { ShieldCheck, Sparkles, Award, Gift, Check } from 'lucide-react';
      ...
      <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
        <div className="flex-1 text-center sm:text-right space-y-2.5 w-full">
          ...
          <p className="text-xs text-stone-500 leading-relaxed">
            امسح الرمز عند كل زيارة ليختم لك الكاشير وتفتح لقطاتك وتستلم <span className="font-bold text-stone-800">{giftTitle}</span>.
          </p>
          ...
          <div className="pt-2 flex flex-col sm:flex-row items-stretch sm:items-center gap-2">
            ...
            >
              ...
              <span>ختم مباشر للموظف (Staff Stamp / PIN)</span>
            </button>
          </div>
