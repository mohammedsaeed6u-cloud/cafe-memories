...
export function MarketingRetentionLoop() {
  const pillars = [
    {
      num: '01',
      title: 'هوية بصرية متكاملة بشعار مقهاك',
      desc: 'تظهر هوية وشعار وألوان مقهاك على كل شريط تصوير، مع استوديو مخصص يمنح كل زائر تجربة متناسقة تماماً مع طابع المكان دون الحاجة لشراء أو صيانة كبائن مخصصة.',
      icon: Layers,
