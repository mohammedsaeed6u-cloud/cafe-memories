  ...
  const steps = [
    {
      ...
      badge: 'بدون أي تطبيق',
      desc: 'يمسح الزائر رمز الطاولة أو الكاونتر بكاميرا هاتفه فيفتح استوديو التصوير المخصص بهوية علامتك التجارية فوراً، ليلتقط صوراً مميزة بألوان ونمط متجرك وبدون أي تسجيل معقد.',
      icon: Camera,
