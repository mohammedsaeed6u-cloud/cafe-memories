...
export function MarketingFaq() {
  const faqs = [
    ...
    },
    {
      ...
      a: 'نعم بالكامل. تتيح لك لوحة التحكم رفع شعار المقهى، اختيار ألوان الكارت، كتابة اسم حساب إنستغرام لعمل المنشن التلقائي، وتحديد نمط الفريم (كوري، نوار، إيديتوريال، أو بطاقة بريدية).',
    },
    {
      q: 'كيف يعمل نظام ولاء العملاء والأختام الرقمية؟',
      a: 'يحصل الزائر على كارت ولاء رقمي يُحفظ في محفظة الهاتف (Apple Wallet / Google Wallet). مع كل زيارة يمسح الباريستا كود العميل السريع أو يُدخل رمز PIN لمنحه ختماً، وعند اكتمال الأختام تُفتح له المكافأة المستحقة.',
    },
    {
      q: 'كيف تتم مراجعة واعتماد الصور قبل ظهورها على شاشة الصالة؟',
      a: 'تمر الصور بمرحلتين أمان: أولاً موافقة الزائر الصريحة على رغبته بالظهور في الشاشة، وثانياً مراجعة فورية من طاقم المقهى عبر تبويب (اعتماد الذكريات) في لوحة التحكم لمنع ظهور أي محتوى غير لائق.',
    },
    {
      q: 'هل يستطيع الزائر حذف صوره وبياناته في أي وقت؟',
      a: 'نعم، نحترم خصوصية الزوار تماماً. تحتوي واجهة الزائر على خيار طلب حذف الصورة والبيانات، كما يمكن لفريق المقهى إخفاء أو حذف أي ذكرى مباشرة من لوحة التحكم.',
    },
    {
      q: 'كم مدة الاحتفاظ بالصور في النظام؟',
      a: 'تُحفظ صور الزوار المعتمدة طالما كان الحساب نشطاً لتمكين الزائر من استعراض ذكرياته واسترداد مكافآته، مع تطبيق ضغط WebP عالي الكفاءة، ويحق للعميل أو المقهى طلب حذفها في أي لحظة.',
    },
    {
      q: 'هل يمكنني إدارة أكثر من فرع للمقهى من حساب واحد؟',
    ...
    {
      q: 'ماذا يحدث إذا انقطع اتصال الإنترنت مؤقتاً في المقهى؟',
