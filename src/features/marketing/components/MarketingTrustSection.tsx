...
export function MarketingTrustSection() {
  const trustPoints = [
    ...
    },
    {
      ...
      desc: 'بيانات مقهاك، سجلات عملائك، وصور روادك معزولة بالكامل في مسار سحابي مستقل مشفر، ولا يمكن لأي متجر آخر الاطلاع عليها.',
      icon: Database,
    },
    {
      title: 'صلاحيات وصول محمية (Role-Based Access)',
      desc: 'فصل تام بين صلاحيات الباريستا السريعة (ختم الكارت واعتماد الذكريات برمز PIN) وصلاحيات الإدارة والتحليلات والإعدادات.',
      icon: UserCheck,
    },
    {
      title: 'حق الحذف الفوري (Data Deletion)',
      desc: 'يحق لأي زائر طلب حذف صوره وسجلاته في أي وقت بضغطة زر من صفحة التجربة، كما يملك صاحب المقهى صلاحية حذف أو إخفاء أي محتوى فوراً.',
      icon: Trash2,
    },
    {
